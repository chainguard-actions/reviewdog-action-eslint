...
# "src/**/*.{ts,tsx}"). Use xargs-based tokenization so the shell performs
# word splitting and quote removal on the value without executing arbitrary
# shell commands via eval.
ESLINT_FLAGS_ARRAY=()
